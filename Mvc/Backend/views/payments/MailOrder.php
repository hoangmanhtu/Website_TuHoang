...
<div class="container">
  ...
  <p>Cảm ơn bạn đã tin tưởng và mua hàng tại Showroom đồ điện tử <strong>Tú Hoàng</strong></p>
  <h3>Mã đơn hàng của bạn là : #<span style="font-weight: bold"><?php echo  $_SESSION["order"]["id"];  ?></span></h3>
  <p>Số tiền bạn đã phải thanh toán là : <?php echo number_format($_SESSION["order"]["price_total"]); ?> VNĐ</p>

  <p>Nếu có vấn đề gì về mua hàng bạn có thể liên hệ với chúng tôi qua số hottline : <a href="tel:0395679339">039.567.9339</a></p>
  <br>
</div>
