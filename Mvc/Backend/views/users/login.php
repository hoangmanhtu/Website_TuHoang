...
<head>
  ...
  <title>Showroom Tú Hoàng | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href=""><b>Tú Hoàng </b>Electronic</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <?php endif;?>
    <p class="login-box-msg">Chào mừng bạn đến với Showroom Tú Hoàng</p>
    ...
    <div class="social-auth-links text-center">
      <p style="color: grey"> Copyright &copy; Hoàng Mạnh Tú - Developer PHP </p>
