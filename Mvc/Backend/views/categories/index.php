...
<div style="text-align: right;margin-bottom: 15px;">
  <a href="index.php?area=backend&controller=category&action=create" class="btn btn-success"><i class="fa fa-plus"></i> Thêm danh mục mới</a>
</div>
<div class="box">
...
<!--                -->
                <td style="text-align: center;">
                  ...
                  <img style="margin: 10px 0px;border-radius: 3px;" src="Assets/Uploads/categories/<?php echo $category['avatar']; ?>" width="70" height="50"/>
                  <?php endif; ?>
                </td>
                <td>
                    <?php
