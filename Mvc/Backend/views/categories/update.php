    ...
    <div class="box-body">
        <form role="form" id="category_form" enctype="multipart/form-data" method="POST">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" readonly value="<?php echo isset($category["name"]) ? $category["name"] : $_POST['name'] ?>" class="form-control" placeholder="Tên của danh mục ...">
            </div>
            <!-- textarea -->
            <div class="form-group">
                ...
                <?php if (!empty($category['avatar'])): ?>
                    <img style="margin: 10px 0px; border-radius: 3px" src="Assets/Uploads/categories/<?php echo $category['avatar']; ?>" height="80" width="120"/>
                <?php endif; ?>
            </div>
          <div class="form-group">
              <?php
