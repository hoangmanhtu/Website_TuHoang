      ...
      <div class="box ">
        <div class="box-body">
          <div class="form-group">
            ...
            <input type="text" readonly minlength="6" value="<?php echo isset($product["title"]) ? $product["title"] : $_POST["title"] ?>" class="form-control required" name="title" placeholder="Nhập tên sản phẩm ..." >
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea cols="30" rows="5" class="form-control " placeholder="Mô tả chi tiết sản phâm" name="content"><?php echo isset($product["content"]) ? $product["content"] :'' ?></textarea>
          </div>
        </div>
      </div>
    </div>
