...
//    thêm mới sản phẩm
    public function insert()
    {
        $obj_insert = $this->connection
            ->prepare("INSERT INTO products(category_id,producer_id ,title,present,
                                avatar, price , quality , discount ,summary, content, status , hotproduct) 
                                VALUES (:category_id,:producer_id ,:title,:present, :avatar, :price, :quality ,
    ...
    public function update($id)
    {
        $obj_update = $this->connection
            ->prepare("UPDATE products SET category_id=:category_id,producer_id=:producer_id ,title=:title, 
                                quality=:quality , discount=:discount, avatar=:avatar, price=:price,present=:present,
