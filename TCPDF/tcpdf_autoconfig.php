...
// Authors     : Hoàng Mạnh Tú LTD - www.tecnick.com - info@tecnick.com
// License     : GNU-LGPL v3 (http://www.gnu.org/copyleft/lesser.html)
// -------------------------------------------------------------------
// Copyright (C) 2011-2014 Hoàng Mạnh Tú LTD
//
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Showroom Tú Hoàng');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by Hoàng Mạnh Tú\nwww.localhost/Website_Tu_Hoang/index.php");
}
