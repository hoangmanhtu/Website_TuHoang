...
// -------------------------------------------------------------------
// Copyright (C) 2008-2014 Hoàng Mạnh Tú LTD
//
...
/**
 * @class TCPDFBarcode
 * PHP class to creates array representations for common 1D barcodes to be used with TCPDF (http://localhost/Website_Tu_Hoang/index.php).<br>
 * @package com.tecnick.tcpdf
 * @version 1.0.027
 * @author Nicola Asuni
 */
