...
// Author      : Hoàng Mạnh Tú LTD - www.tecnick.com - info@tecnick.com
// License     : GNU-LGPL v3 (http://www.gnu.org/copyleft/lesser.html)
// -------------------------------------------------------------------
// Copyright (C) 2002-2019 Hoàng Mạnh Tú LTD
//
 ...
 * TCPDF project (http://localhost/Website_Tu_Hoang/index.php) was originally derived in 2002 from the Public Domain FPDF class by Olivier Plathey (http://www.fpdf.org), but now is almost entirely rewritten.<br>
 ...
 * TCPDF project (http://localhost/Website_Tu_Hoang/index.php) has been originally derived in 2002 from the Public Domain FPDF class by Olivier Plathey (http://www.fpdf.org), but now is almost entirely rewritten.<br>
 * @package com.tecnick.tcpdf
...
//      $this->Cell(0, 15, '<< TCPDF Example 003 >>', 0, false, 'C', 0, '', 0, false, 'M', 'M');
    ...
    $this->Cell(34,1,'__________________',0,0);
    $this->Cell(118,2,'',0,0);
    $this->Cell(51,1,'__________________',0,1);
    $this->Cell(30,5,'Chữ ký của quý khách ',0,0);
    $this->Cell(121,5,'',0,0);
    $this->Cell(71,5,'Xác nhận của cửa hàng',0,1);
    $this->Cell(10,3,'',0,0);
    $this->SetFont('freeserif', 'i', 11);
    $this->Cell(30,8,'(Chữ ký)',0,0);
    $this->Cell(121,5,'',0,0);
    $this->Cell(71,8,'(Chữ ký)',0,1);
    $this->Ln(50);
    $this->Cell(89,5,'',0,1,'C');

    date_default_timezone_set('Asia/Ho_Chi_Minh');
    $this->SetFont('freeserif', 'italic', 11);
    $today=date('d-m-Y H:i:s',time());
    $this->Cell(25,5,'Thời gian '.$today,0,0,'L');
		...
		switch($tag['value']) {
			case 'tr': {
				...
				if (isset($dom[$table_el]['rowspans'])) {
					...
					// reports new endy and endpage to the rowspanned cells
					foreach ($dom[$table_el]['rowspans'] as $k => $trwsp) {
						if ($dom[$table_el]['rowspans'][$k]['rowspan'] == 0) {
