...
$pdf->SetTitle('Showroom Tú Hoàng 058');
...
$pdf->ImageSVG($file='images/testsvg.svg', $x=15, $y=30, $w='', $h='', $link='http://localhost/Website_Tu_Hoang/index.php', $align='', $palign='', $border=1, $fitonpage=false);
